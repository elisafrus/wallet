...
window.addEventListener('load', () => {
  ...
  function openEditModal(transaction) {
    ...
    const formattedDate = new Date(new Date(transaction.date) - userTimezoneOffset)
      .toISOString()
      .split('T')[0];
    ...
    editModalContent.classList.add(
      transactionType === 'expenses' ? 'expenses-content' : 'income-content',
    );
    ...
    const categories = [
      ...
      'financial expenses',
      'other',
    ]; // Замініть це на ваш список категорій
